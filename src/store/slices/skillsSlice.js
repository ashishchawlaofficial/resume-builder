...
export const getSkillsData = (requestUrlChunk) => async (dispatch) => {
...
export const deleteSkillsRecord = (requestUrlChunk, id) => async (dispatch) => {
  const requestChunk = {
    ...requestUrlChunk,
    endpointKey: `skills/${id}`,
  };

...
// Async API Functions
export const saveCertificationData =
  ({ ...data }) =>
  async (dispatch) => {
...
export const getCertificationData = (requestUrlChunk) => async (dispatch) => {
...
export const deleteCertificationRecord =
  (requestUrlChunk, id) => async (dispatch) => {
    const requestChunk = {
      ...requestUrlChunk,
      endpointKey: `certification/${id}`,
    };

...
export const getEducationData = (requestUrlChunk) => async (dispatch) => {
...
export const deleteEducationRecord =
  (requestUrlChunk, id) => async (dispatch) => {
    const requestChunk = { ...requestUrlChunk, endpointKey: `education/${id}` };

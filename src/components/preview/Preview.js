...
import styles from "../../assets/css/devresume.css";
...
const ResumePreview = () => {
  ...
  <html lang="en">
    <head>
      <title>
        DevResume - Bootstrap 4 Resume/CV Template For Software Developers
      </title>
      ...
      <!-- Theme CSS -->
      <link id="theme-style" rel="stylesheet" href="https://themes.3rdwavemedia.com/demo/bs5/devresume/assets/css/devresume.css" />
    </head>
    ...
    <body>
      <div class="main-wrapper">
        <div class="container">
          <article
            class="resume-wrapper mx-auto theme-bg-light p-5 mb-5 my-5"
          >
